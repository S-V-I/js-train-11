// Завдання: 1
/**
 * Функція `customSet` створює множину з масиву чисел та рядків, але видаляє
 * всі елементи, які є числами.
...
function customSet(arr) {
  ...
  // Перебираємо множину за допомогою 'for of'. Цикл 'for of' дозволяє пройтись
  // по всіх елементах колекції.
  // Для кожного елемента перевіряємо, чи є цей елемент числом за допомогою
  // оператора typeof
...
// Завдання: 3
/**
 * Функція `addElements` додає елементи до множини з масиву, якщо вони ще
 * не присутні у множині.
...
// Завдання: 4
/**
 * Функція `filterAndAdd` видаляє з множини всі числові елементи та додає
 * до множини унікальні значення з масиву,
 * якщо вони ще не присутні в множині. В результаті отримуємо множину,
 * що містить лише рядкові значення.
 *
...
function filterAndAdd(mySet, arr) {
  ...
  // Тепер множина не містить числових значень.
  // Перебираємо масив та додаємо кожний елемент до множини
  // за допомогою методу add. Метод add додає елемент до множини лише якщо
  // він ще не присутній у множині.
  // Повертаємо оновлену множину
...
function checkValueAndType(mySet, value) {
  ...
  // Якщо значення знайдено, повертаємо рядок Множина має значення "${value}"
  // типу "${typeof value}".
  // Якщо значення не знайдено, повертаємо рядок
 ...
 * числові елементи та відсортовує рядкові елементи в алфавітному порядку.
 *
...
function setToArray(mySet) {
  ...
  // що містить лише рядкові елементи.
  // Використовуємо метод sort для сортування рядкових елементів
  // в алфавітному порядку.
  // Повертаємо оброблений масив.

  mySet = [...mySet];
  // console.log(mySet);
  const arr = mySet.filter((mySet) => typeof mySet === "string");
  // console.log(arr);
  return arr.sort();
}
...
/**
 * Функція `removeDuplicatesInPlace` видаляє дублікати з масиву без створення
 * нового масиву.
...
function removeDuplicatesInPlace(arr) {
  ...
  const set = new Set(arr);
  console.log(set); // результат - вийшов такий же, як вимагається в умові :))
}
...
/**
 * Функція `areDisjoint` перевіряє, чи є дві множини неспільними
...
/**
 * Функція `getDifference` повертає множину, яка містить елементи, що належать
 * першій множині, але не належать другій множині.
 * set1 - Перша множина.
 * set2 - Друга множина.
...
/**
 * Функція `getIntersection` повертає множину, яка містить спільні елементи
 * двох масивів.
 * arr1 - Перший масив.
 * arr2 - Другий масив.
